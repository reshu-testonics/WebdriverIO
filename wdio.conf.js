...
exports.config = {
    ...
    capabilities: [{
        ...
        //Below configurations are to run the test in headless mode in chrome
        // 'goog:chromeOptions': {
        //     args: [
        //         '--no-sandbox',
        //         '--disable-infobars',
    ...
    jasmineOpts: {
        ...
        expectationResultHandler: function(passed, assertion) {
            ...
            browser.saveScreenshot(`/reports/jasmine/assertionError_${assertion.error.message}.png`)
        }
    },
    ...
    cucumberOpts: {
        ...
        format: [['html',{outputDir:"reports"}],'pretty'], // <string[]> (type[:path]) specify the output format, optionally supply PATH to redirect formatter output (repeatable)
    ...
    before: function (capabilities, specs) {
        global.url ="https://the-internet.herokuapp.com/login"
        global.user="tomsmith"
        global.password="SuperSecretPassword!"
    },
    /**
